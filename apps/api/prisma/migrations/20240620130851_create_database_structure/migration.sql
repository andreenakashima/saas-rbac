-- CreateEnum
CREATE TYPE "TokenType" AS ENUM ('PASSSWORD_RECOVER');

-- CreateEnum
CREATE TYPE "AccountProvider" AS ENUM ('GIHUB');
...
CREATE TABLE "members" (
    ...
    "organinization_id" TEXT NOT NULL,
    "user_id" TEXT NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "members_organinization_id_user_id_key" ON "members"("organinization_id", "user_id");
...
-- AddForeignKey
ALTER TABLE "members" ADD CONSTRAINT "members_organinization_id_fkey" FOREIGN KEY ("organinization_id") REFERENCES "organizations"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
